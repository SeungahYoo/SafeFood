...
<body>
		...
		<nav
			...
			<div class="container">
				...
				<!-- Brand -->
				<img class="image" alt="ssafy" src="${pageContext.request.contextPath}/resources/img/ssafy_logo.png"
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item"><a class="nav-link"
							href="https://mdbootstrap.com/docs/jquery/" target="_blank">공지
								사항</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/foodlist/index.jsp" target="_blank">식품 목록</a></li>
						<li class="nav-item"><a class="nav-link"
